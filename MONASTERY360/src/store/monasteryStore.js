...
export const useMonasteryStore = create((set, get) => ({
  monasteries: [
    ...
    },
    {
      ...
      accessibility: "Moderate",
      description:
        "Sacred monastery known for its holy water and spiritual significance.",
    ...
    },
    {
      ...
      accessibility: "Difficult",
      description:
        'The first monastery built in Sikkim, known as "The Retreat".',
      highlights: [
  ...
  getFilteredMonasteries: () => {
    ...
    return monasteries.filter((monastery) => {
      ...
      const matchesDistrict =
        !filters.district || monastery.district === filters.district;
      const matchesTradition =
        !filters.tradition || monastery.tradition === filters.tradition;
      const matchesAccessibility =
        !filters.accessibility ||
        monastery.accessibility === filters.accessibility;
      const matchesVirtualTour =
        !filters.hasVirtualTour || monastery.hasVirtualTour;
