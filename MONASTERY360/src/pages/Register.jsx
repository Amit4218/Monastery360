        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
          ...
          >
                ...
                {[1, 2, 3].map((step) => (
                  <motion.div
                    ...
                    animate={{
                      ...
                      backgroundColor: currentStep >= step ? '#d4af37' : 'rgba(255,255,255,0.2)'
                    }}
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      <div>
                        <label className="block text-white/90 text-sm font-medium mb-4">
                          {t('auth.interests', 'What interests you?')} ({t('auth.optional', 'Optional')})
                        </label>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-white/80 text-sm">
                          ...
                          <Link to="/terms" className="text-tibetan-gold hover:underline">
                            {t('auth.termsOfService', 'Terms of Service')}
                          </Link> {' '}
                          {t('auth.and', 'and')} {' '}
                          <Link to="/privacy" className="text-tibetan-gold hover:underline">
                ...
                <div className="flex space-x-4">
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={isLoading}
                    className={`${currentStep === 1 ? 'w-full' : 'flex-1'} bg-gradient-to-r from-tibetan-gold to-monastery-600 text-white py-4 rounded-2xl font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center space-x-2`}
                  >
                    <AnimatePresence mode="wait">
                      {isLoading ? (
                        <motion.div
                        ...
                        >
                          <span>{currentStep === 3 ? t('auth.createAccount', 'Create Account') : t('auth.continue', 'Continue')}</span>
              ...
              >
                <span className="text-white/70">{t('auth.haveAccount', 'Already have an account?')} </span>
                <Link
                  to="/login"
